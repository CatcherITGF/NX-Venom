...
var CustTable = [
    ...
    new CustEntry("marikoCpuMaxVolt", "Mariko CPU Max Voltage in mV", CustPlatform.Mariko, 4, ["Acceptable range: 1100 ≤ x ≤ 1235",
        "System default: 1120, L4T OC: 1235",
        "Changing this value affects cpu voltage calculation"], 1125, [1100, 1235], 5),
    ...
    new CustEntry("mtcConf", "DRAM Timing", CustPlatform.All, 4, ["<b>0</b>: AUTO_ADJ: Auto adjust mtc table with LPDDR4 3733 Mbps specs, 16Gb density. Change timing with Advanced Config (Default)",
        "<b>1</b>: AUTO_ADJ_LV: Less tight timings. It can help to achieve higher frequencies or lower voltages. Mainly for Erista.",
