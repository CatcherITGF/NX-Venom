...
Отдельное спасибо b7311, lineon, Руслану, CtC а так же дискорд комьюнити `NSwitch 60FPS Cheats & Mods` и `RetroNX` за реализацию отдельных компонентов этого бандла
