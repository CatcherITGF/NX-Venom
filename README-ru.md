...
Отдельное спасибо meha, b0rd2dEAth, b3711, lineon, Руслану, CtC, дискорд комьюнити `NSwitch 60FPS Cheats & Mods` и `RetroNX` за реализацию отдельных компонентов этого бандла
