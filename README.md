...
2. Unpack the [OC Bundle](https://github.com/CatcherITGF/NS-Overclocking/raw/main/OCBundle.zip) to the root of the SD card. Use a card reader, or `Hekate` → `Tools` → `USB Tools`.
